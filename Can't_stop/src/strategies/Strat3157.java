...
public class Strat3157 implements Strategie {
    ...
    */
    ...
    private boolean test(int[][] bonzes, int[] avancement, int[] max){

        for(int i = 0; i<3; i++){
            if((bonzes[0][1] - avancement[bonzes[0][0] - 2]) >= (max[bonzes[0][0] - 2]/3)){
                return true;
            }
        }
        return false;
    ...
    */
    public int choix(Jeu j) {
        ...
        for(int i = 0; i < nbChoix; i++){
            //System.out.print(lesChoix[i][0] + " & " + lesChoix[i][1] + " | ");
        }
        //System.out.println(" ");
    ...
    */
    public boolean stop(Jeu j) {
        ...
        for(int i =0; i < avancement.length; i++){
            //System.out.print( avancement[i] + " | ");
        }

        for(int i =0; i < 3; i++){
            //System.out.print( bonzes[i][0] + ":" + bonzes[i][1] + " & ");
        }
        //System.out.println(" ");
        ...
        if(j.getBonzesRestants() <= 0){
            testStop = test(bonzes, avancement, max);
            count += 1;
        }
